<?php 
    ...
    if(mysqli_query($conn,"SELECT * from monan LIMIT $start, $limit"))
    {
        $count= mysqli_query($conn,"SELECT * from monan LIMIT $start, $limit");
    ...
    $count= mysqli_query($conn,"SELECT count(*) as total from monan");
             ...
             ?>
                    <div class="list-header">
                        <div class="header-title">
                            <h4>Danh sách Món Ăn<h6>- <?php echo $total['total'] ?></h6></h4>
                        </div>
                        <div class="header-choose">
                            <a href="./themmonan.php" class="user-add" style="text-decoration: none;">
                                        ...
                                        foreach($data as $userinfor) : ?>
                                                ...
                                                <td>
                                                    <div class="infor-employ">
                                                        <img src="<?= "../imgmonan/".$userinfor['hinhanh'].".png"?>" alt="">
                                                        <div><?= $userinfor['Tenmon'] ?> </div>
                                                    </div>
                                                </td>
                                                <td><?= $userinfor['giamon']."K" ?></td>
                                                <td> <?php 
                                                    if($userinfor['available'] == 1)
                                                        echo "Còn hàng";
                                                    else if($userinfor['available'] == 0)
                                                        echo "Hết hàng";
                                                ?></td>
                                                <td><?php 
                                                    if($userinfor['phanloai'] == 1)
                                                        echo "Nước Uống";
                                                    else if($userinfor['phanloai'] == 0)
                                                        echo "Món ăn";
                                                ?></td>
                                                <td class="see-edit-delete">
                                                    <a href="./suamonan.php?idmon=<?=$userinfor['id_monan']?>" class="link-edit bd-rd-rem" onclick="showModalEdituser()">
                            ...
                            <ul class="list-user-page">
                                <div>
                                    ...
                                    <a <?php if($page == 1)
                                                ...
                                                echo "href=./quanlymonan.php?page=1";               
                                        ?>>
                                    ...
                                    <li class="arrow-back-list-user">
                                        <a <?php if($previous<1)
                                                ...
                                                echo "href=./quanlymonan.php?page=".$previous;  
                                        ?>>
                                    ...
                                    <a <?php if($i==$page)
                                                ...
                                                echo "href=./quanlymonan.php?page=".$i;  
                                        ?>>
                                        <div>
                                             <?= $i; ?>
                                        </div>
                                    ...
                                    <a <?php if($next>$pages)
                                                ...
                                                echo "href=./quanlymonan.php?page=".$next;               
                                        ?>>
                                    ...
                                    <a <?php if($page == $pages)
                                                ...
                                                echo "href=./quanlymonan.php?page=".$pages;               
                                        ?>>
