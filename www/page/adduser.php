...
<?php 
    ...
    if(isset($_POST['adduser']))
    {
        ...
        if(empty($error)) 
        {
            ...
            $sql2 = "INSERT INTO luongnhanvien(id_nhanvien,luongcoban,chisoluong)
            VALUES ('$idnhanvien',20000000,1)";
                        ...
                        <ul class="menu-itmes js-menu-itmes">
                            <li class="items-icon items-icon-hover js-items-icon" >
                                ...
                                <ul class="icon-setting-pic js-icon-setting-show bd-rd-rem">
                                    <li class="setting-items"><a href="./profile.php" class="items-link">Profire</a></li>
                        ...
                        <div class="add-user-content">
                            ...
                            <form method="POST" action="">
                                ...
                                <div class="form-input-add">
                                    ...
                                    <select class = "chon-phongban" name="chucvu">
                                        <option selected value>Chọn Phòng ban</option>
                                        <option value= "2">Quản lý phòng hát</option>
                                        <option value= "3">Quản lý Nhân sự, khách hàng</option>
