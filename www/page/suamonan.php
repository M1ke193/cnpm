<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if(empty($error)) 
        {
            $idimg = monan($idmonan)['hinhanh'];
            $sql = "UPDATE monan
                    SET Tenmon = '$name', giamon = '$gia', phanloai = '$loai', available = '$tinhtrang'    
            ...
            if($query){
                ...
                header("Location: ./quanlymonan.php?chinhsua=1");
            }
            mysqli_close($mysqli);
        }
    }
            ...
            <div class="management-user">
                ...
                <div class="add-user-header">
                        <div class="add-user-content">
                            <h2 class="add-user-title">Chỉnh sửa Món</h2>
                    <form id="change-img" method="post" enctype="multipart/form-data" >
                            <div class="img-profile">
                                    <?php 
                                            $imgt = "../imgmonan/".monan($idmonan)['hinhanh'].".png";
                                    ?> 
                                    <img id ="anh" src=<?=$imgt?>>
                            ...
                            <div class="alert alert-danger error-file" id="error-file"style="display:none">Định dạng file không hợp lệ</div>
                                <div class="form-input">
                                    ...
                                    <input class="bd-rd-rem" id="name" type="text" value="<?=monan($idmonan)['Tenmon']?>"  placeholder="Nhập Tên món" name="name">
                                </div>
                                ...
                                <div class="form-input">
                                    ...
                                    <input class="bd-rd-rem" id="gia" name = "gia" type="number"  value="<?=monan($idmonan)['giamon']?>" placeholder="Giá món">
                                </div>
                                ...
                                <?php if (monan($idmonan)['phanloai'] == 1): ?>
                                ...
                                <?php endif; ?>
                                <?php if (monan($idmonan)['phanloai'] == 0): ?>
                                    <div class="form-input-add">
                                        <label for="phongban">Phân loại</label>
                                        <select class = "chon-phongban" name="loai">
                                            <option value= "1">Nước Uống</option>
                                            <option value= "0" selected="selected">Món ăn</option>
                                        </select>
                                    </div>
                                <?php endif; ?>
                                <?php if (monan($idmonan)['available'] == 1): ?>
                                <div class="form-input-add">
                                ...
                                <?php endif; ?>
                                <?php if (monan($idmonan)['available'] == 0): ?>
                                <div class="form-input-add">
                                    <label for="phongban">Tình trạng</label>
                                    <select class = "chon-phongban" name="tinhtrang">
                                        <option value= "1">Còn hàng</option>
                                ...
                                <div class="form-group">
                                    <button onclick="luuanh2()" name="adduser" type="button"class="btn-login bd-rd-rem">Sửa</button>
                                </div>
                            </form>
                        </div>
                    </div>
